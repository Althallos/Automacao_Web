...
elemento.click()
"""
# Opção 2 : criar um while que verifica se o elemento apareceu(se não aparecer = 0 | se aparecer = 1)
...
driver.get(link)
sleep(7)
#   Entrando dentro de um iframe
iframe = driver.find_element(by=By.TAG_NAME, value='iframe')
driver.switch_to.frame(iframe)

#   Entrando dentro de um iframe dentro de outro iframe
iframe = driver.find_element(by=By.TAG_NAME, value='iframe')
driver.switch_to.frame(iframe)
